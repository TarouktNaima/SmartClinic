...
export default function AddSecretary() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Secrétaire ajoutée avec succès");
          ...
          >
            ...
            <div className="mb-8 overflow-hidden rounded-[26px] border border-[#B3CFE5]/20 bg-gradient-to-br from-[#0A1931] via-[#102A4B] to-[#1A3D63] p-6 shadow-2xl shadow-[#0A1931]/40">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-[#F6FAFD]/75">
                Créez un compte secrétaire pour gérer les rendez-vous et
                consulter les informations principales de la clinique.
              </p>
            </div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm leading-6 text-[#B3CFE5]">
                    La secrétaire peut suivre les rendez-vous, consulter les
                    informations utiles et faciliter l’organisation quotidienne.
                  </p>
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <InputBox
                    icon={Mail}
                    type="email"
                    placeholder="Email de la secrétaire"
                    value={email}
                    setValue={setEmail}
                  />
