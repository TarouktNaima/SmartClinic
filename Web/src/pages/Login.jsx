...
import toast, { Toaster } from "react-hot-toast"; // Import professionnel
...
function Login() {
  ...
  const handleLogin = async () => {
    // Alert d l-loading bach t-ban pro
    ...
    try {
      ...
      // Success Toast - Style Minimaliste & Pro
      toast.success("Bienvenue sur SmartClinic ✅", {
        id: loadingToast, // Kat-bdl l-loading b success
        style: {
      ...
      toast.error("Identifiants incorrects ❌", {
        id: loadingToast, // Kat-bdl l-loading b error
        style: {
          background: "rgba(255, 255, 255, 0.7)",
          backdropFilter: "blur(10px)",
          color: "#b91c1c",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#82BCE0] via-[#CAE3F0] to-[#F3F9FC] p-4">
      {/* Had Toaster howa li kikhli les alertes ibanou b style wa3er */}
      <Toaster
        position="top-center"
        toastOptions={{
          className: "",
