...
function Login() {
  ...
  const features = [
    { icon: CalendarDays, title: "Rendez-vous", text: "Planifiez et gérez facilement" },
    { icon: Users, title: "Patients", text: "Accédez aux dossiers en toute sécurité" },
    { icon: BarChart3, title: "Statistiques", text: "Suivez l'activité de votre cabinet" },
    { icon: ShieldCheck, title: "Sécurité", text: "Vos données sont protégées" },
  ];
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#B3CFE5]">Votre santé, notre priorité</p>
              </div>
            </div>

            <div className="mt-16">
              <h2 className="text-3xl font-extrabold leading-tight">
                Bienvenue <span className="block text-[#8CB9FF]">sur SmartClinic</span>
              </h2>
              <div className="mt-5 h-1 w-12 rounded-full bg-[#6DA8FF]" />
              <p className="mt-6 max-w-sm text-sm leading-7 text-[#F6FAFD]/90">
                Gégez vos patients, vos rendez-vous et votre cabinet médical en toute simplicité.
              </p>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[#B3CFE5]">Données sécurisées et confidentielles</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="relative flex flex-1 items-center justify-center bg-[#F6FAFD] p-5 lg:p-8">
          ...
          >
            ...
            <div className="text-center">
              <h2 className="text-3xl font-extrabold text-[#0A1931]">Connexion</h2>
              <p className="mt-2 text-sm text-[#1A3D63]/75">Connectez-vous à votre compte</p>
            </div>

            <div className="mt-8 space-y-5">
              {/* Email */}
              <div>
                <label className="mb-2 block text-sm font-bold text-[#0A1931]">Adresse e-mail</label>
              ...
              {/* Password */}
              <div>
                <label className="mb-2 block text-sm font-bold text-[#0A1931]">Mot de passe</label>
                <div className="flex h-12 items-center rounded-xl border border-[#D8E6F3] bg-white shadow-sm focus-within:border-[#4A7FA7] focus-within:ring-4 focus-within:ring-[#B3CFE5]/40">
                  <div className="flex h-full w-12 items-center justify-center border-r border-[#D8E6F3] text-[#1A3D63]">
                    <Lock size={19} />
                  </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="rounded-full bg-white px-3 py-1 text-xs font-bold text-[#1A3D63]">ou</span>
                <div className="h-px flex-1 bg-[#D8E6F3]" />
              </div>
