...
function RdvList() {
  ...
  return (
    <div className="min-h-screen bg-[#07101f] text-white p-6 md:p-10">
      <Toaster />

      {/* BACKGROUND GLOW */}
      <div className="fixed -top-40 -left-40 w-[500px] h-[500px] bg-indigo-600/20 blur-[140px]" />
      <div className="fixed -bottom-40 -right-40 w-[500px] h-[500px] bg-cyan-500/10 blur-[140px]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white/50 mt-2">
            Gestion des consultations et validation médicale
          </p>
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-2xl bg-white/5 border border-white/10 outline-none focus:border-indigo-400"
            />
          </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/50">
                        Dr. {a.doctor?.name} • {a.doctor?.specialite}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-emerald-500/10 text-emerald-300 text-xs"
                    >
                      <CheckCircle size={14} />
                    </button>
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-red-500/10 text-red-300 text-xs"
                    >
                      <XCircle size={14} />
                    </button>
                  </div>
