            ...
            {doctors.length > 0 ? (
              doctors.map((doc, idx) => (
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                  // Card style: Glassmorphism mtnasq m3a l-Login
